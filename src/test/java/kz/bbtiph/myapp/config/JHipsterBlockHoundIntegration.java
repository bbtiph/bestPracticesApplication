package kz.bbtiph.myapp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("kz.bbtiph.myapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("kz.bbtiph.myapp.security.DomainUserDetailsService", "createSpringSecurityUser");
